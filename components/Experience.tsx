...
const JOBS: Job[] = [
  {
    ...
    bullets: [
      ...
      "Developed a real estate platform with 1,000+ listings, implementing property registration, seller profiles, browse and filter, appointment scheduling, and pricing views.",
            ...
            {JOBS.map((job, i) => (
              ...
              >
                ...
                <div className="hidden md:flex flex-shrink-0 w-10 justify-center">
                  <div
                    className="w-4 h-4 rounded-full bg-blue-500 border-4 border-white shadow-md ring-2 ring-blue-200 z-10"
                ...
                <div className="flex-1 bg-white border border-slate-200 rounded-2xl shadow-sm hover:shadow-md transition-all overflow-hidden">
                  {/* Card top accent bar */}
                  <div
                    className={`h-1 w-full ${job.current ? "bg-gradient-to-r from-blue-500 to-indigo-500" : "bg-gradient-to-r from-slate-300 to-slate-200"}`}
                  />
                  ...
                  <div className="p-4 sm:p-6">
                    ...
                    <div className="flex items-start justify-between gap-3 mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-blue-500 font-semibold text-xs sm:text-sm mt-0.5">
                            {job.role}
                          </p>
                        </div>
                      </div>
                    ...
                    <ul className="space-y-2.5">
                      {job.bullets.map((bullet, bi) => (
                        <li
                          key={bi}
                          className="flex gap-2.5 text-slate-600 text-xs sm:text-sm leading-relaxed"
                        >
